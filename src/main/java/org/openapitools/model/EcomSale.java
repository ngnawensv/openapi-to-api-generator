...
public class EcomSale {
   ...
   */
  public EcomSale(Integer custId) {
    this.custId = custId;
  }

  public EcomSale saleId(Integer saleId) {
    this.saleId = saleId;
    return this;
  }
  ...
  */
  ...
  public EcomSale custId(Integer custId) {
    this.custId = custId;
    return this;
  }
  ...
  */
  ...
  public EcomSale saleDate(OffsetDateTime saleDate) {
  ...
  */
  ...
  public EcomSale totalInvoiceAmount(Double totalInvoiceAmount) {
  ...
  */
  ...
  public EcomSale discount(Double discount) {
  ...
  */
  ...
  public EcomSale paymentNaration(String paymentNaration) {
  ...
  */
  ...
  public EcomSale deliveryAddress1(String deliveryAddress1) {
  ...
  */
  ...
  public EcomSale deliveryAddress2(String deliveryAddress2) {
  ...
  */
  ...
  public EcomSale deliveryCity(String deliveryCity) {
  ...
  */
  ...
  public EcomSale deliveryPinCode(String deliveryPinCode) {
  ...
  */
  ...
  public EcomSale deliveryLandMark(String deliveryLandMark) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EcomSale ecomSale = (EcomSale) o;
    return Objects.equals(this.saleId, ecomSale.saleId) &&
        Objects.equals(this.custId, ecomSale.custId) &&
        Objects.equals(this.saleDate, ecomSale.saleDate) &&
        Objects.equals(this.totalInvoiceAmount, ecomSale.totalInvoiceAmount) &&
        Objects.equals(this.discount, ecomSale.discount) &&
        equalsNullable(this.paymentNaration, ecomSale.paymentNaration) &&
        equalsNullable(this.deliveryAddress1, ecomSale.deliveryAddress1) &&
        equalsNullable(this.deliveryAddress2, ecomSale.deliveryAddress2) &&
        equalsNullable(this.deliveryCity, ecomSale.deliveryCity) &&
        equalsNullable(this.deliveryPinCode, ecomSale.deliveryPinCode) &&
        equalsNullable(this.deliveryLandMark, ecomSale.deliveryLandMark);
  }
