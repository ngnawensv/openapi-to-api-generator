...
import org.openapitools.model.FoodOrderItem;
...
public class FoodOrderView {
  ...
  @Valid
  private JsonNullable<List<@Valid FoodOrderItem>> foodOrderItems = JsonNullable.<List<@Valid FoodOrderItem>>undefined();

  public FoodOrderView orderId(Integer orderId) {
  ...
  */
  ...
  public FoodOrderView name(String name) {
  ...
  */
  ...
  public FoodOrderView mobileNo(String mobileNo) {
  ...
  */
  ...
  public FoodOrderView orderDate(OffsetDateTime orderDate) {
  ...
  */
  ...
  public FoodOrderView orderTotal(Double orderTotal) {
  ...
  */
  ...
  public FoodOrderView orderUniqeId(String orderUniqeId) {
  ...
  */
  ...
  public FoodOrderView orderStatus(String orderStatus) {
  ...
  */
  ...
  public FoodOrderView bookingId(Integer bookingId) {
  ...
  */
  ...
  public FoodOrderView userId(Integer userId) {
    this.userId = userId;
    return this;
  }
  ...
  */
  ...
  public FoodOrderView orderNo(Integer orderNo) {
  ...
  */
  ...
  public FoodOrderView message(String message) {
  ...
  */
  ...
  public FoodOrderView result(Boolean result) {
    this.result = result;
    return this;
  }
  ...
  */
  ...
  public FoodOrderView foodOrderItems(List<@Valid FoodOrderItem> foodOrderItems) {
    this.foodOrderItems = JsonNullable.of(foodOrderItems);
    return this;
  }

  public FoodOrderView addFoodOrderItemsItem(FoodOrderItem foodOrderItemsItem) {
  ...
  */
  ...
  public JsonNullable<List<@Valid FoodOrderItem>> getFoodOrderItems() {
    return foodOrderItems;
  }

  public void setFoodOrderItems(JsonNullable<List<@Valid FoodOrderItem>> foodOrderItems) {
  ...
  public boolean equals(Object o) {
    ...
    FoodOrderView foodOrderView = (FoodOrderView) o;
    return Objects.equals(this.orderId, foodOrderView.orderId) &&
        equalsNullable(this.name, foodOrderView.name) &&
        equalsNullable(this.mobileNo, foodOrderView.mobileNo) &&
        Objects.equals(this.orderDate, foodOrderView.orderDate) &&
        Objects.equals(this.orderTotal, foodOrderView.orderTotal) &&
        equalsNullable(this.orderUniqeId, foodOrderView.orderUniqeId) &&
        equalsNullable(this.orderStatus, foodOrderView.orderStatus) &&
        equalsNullable(this.bookingId, foodOrderView.bookingId) &&
        Objects.equals(this.userId, foodOrderView.userId) &&
        Objects.equals(this.orderNo, foodOrderView.orderNo) &&
        equalsNullable(this.message, foodOrderView.message) &&
        Objects.equals(this.result, foodOrderView.result) &&
        equalsNullable(this.foodOrderItems, foodOrderView.foodOrderItems);
  }
