...
public class EcomProduct {
   ...
   */
  public EcomProduct(String productSku) {
    this.productSku = productSku;
  }

  public EcomProduct productId(Integer productId) {
  ...
  */
  ...
  public EcomProduct productSku(String productSku) {
    this.productSku = productSku;
    return this;
  }
  ...
  */
  ...
  public EcomProduct productName(String productName) {
  ...
  */
  ...
  public EcomProduct productPrice(Double productPrice) {
  ...
  */
  ...
  public EcomProduct productShortName(String productShortName) {
  ...
  */
  ...
  public EcomProduct productDescription(String productDescription) {
  ...
  */
  ...
  public EcomProduct createdDate(OffsetDateTime createdDate) {
  ...
  */
  ...
  public EcomProduct deliveryTimeSpan(String deliveryTimeSpan) {
  ...
  */
  ...
  public EcomProduct categoryId(Integer categoryId) {
  ...
  */
  ...
  public EcomProduct productImageUrl(String productImageUrl) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EcomProduct ecomProduct = (EcomProduct) o;
    return Objects.equals(this.productId, ecomProduct.productId) &&
        Objects.equals(this.productSku, ecomProduct.productSku) &&
        equalsNullable(this.productName, ecomProduct.productName) &&
        Objects.equals(this.productPrice, ecomProduct.productPrice) &&
        equalsNullable(this.productShortName, ecomProduct.productShortName) &&
        equalsNullable(this.productDescription, ecomProduct.productDescription) &&
        Objects.equals(this.createdDate, ecomProduct.createdDate) &&
        equalsNullable(this.deliveryTimeSpan, ecomProduct.deliveryTimeSpan) &&
        Objects.equals(this.categoryId, ecomProduct.categoryId) &&
        equalsNullable(this.productImageUrl, ecomProduct.productImageUrl);
  }
