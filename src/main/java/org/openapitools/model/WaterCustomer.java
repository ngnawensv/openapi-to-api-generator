...
public class WaterCustomer {
  ...
  private JsonNullable<Integer> packageId = JsonNullable.<Integer>undefined();
   ...
   */
  public WaterCustomer(String name, String mobile) {
    this.name = name;
    this.mobile = mobile;
  }

  public WaterCustomer visitId(Integer visitId) {
  ...
  */
  ...
  public WaterCustomer customerId(Integer customerId) {
  ...
  */
  ...
  public WaterCustomer name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public WaterCustomer mobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  */
  @NotNull 
  @Schema(name = "Mobile", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("Mobile")
  ...
  public WaterCustomer emailId(String emailId) {
  ...
  */
  ...
  public WaterCustomer city(String city) {
  ...
  */
  ...
  public WaterCustomer ticketNo(String ticketNo) {
  ...
  */
  ...
  public WaterCustomer ticketDate(OffsetDateTime ticketDate) {
  ...
  */
  ...
  public WaterCustomer isDelete(Boolean isDelete) {
  ...
  */
  ...
  public WaterCustomer remainingPaidAmt(Double remainingPaidAmt) {
  ...
  */
  ...
  public WaterCustomer createDate(OffsetDateTime createDate) {
  ...
  */
  ...
  public WaterCustomer reference(Integer reference) {
  ...
  */
  ...
  public WaterCustomer paymentBy(String paymentBy) {
  ...
  */
  ...
  public WaterCustomer paymentDetails(String paymentDetails) {
  ...
  */
  ...
  public WaterCustomer isAdvance(Boolean isAdvance) {
  ...
  */
  ...
  public WaterCustomer userId(Integer userId) {
  ...
  */
  ...
  public WaterCustomer noOfMembers(Integer noOfMembers) {
  ...
  */
  ...
  public WaterCustomer totalAmount(Double totalAmount) {
  ...
  */
  ...
  public WaterCustomer serviceId(Integer serviceId) {
  ...
  */
  ...
  public WaterCustomer advance(Double advance) {
  ...
  */
  ...
  public WaterCustomer remaining(Double remaining) {
  ...
  */
  ...
  public WaterCustomer adults(Integer adults) {
  ...
  */
  ...
  public WaterCustomer childrens(Integer childrens) {
  ...
  */
  ...
  public WaterCustomer rate(Integer rate) {
  ...
  */
  ...
  public WaterCustomer adultRate(Integer adultRate) {
  ...
  */
  ...
  public WaterCustomer childRate(Integer childRate) {
  ...
  */
  ...
  public WaterCustomer bookingUId(String bookingUId) {
  ...
  */
  ...
  public WaterCustomer bookingToDate(OffsetDateTime bookingToDate) {
  ...
  */
  ...
  public WaterCustomer isDone(Boolean isDone) {
    this.isDone = isDone;
    return this;
  }
  ...
  */
  ...
  public WaterCustomer isConfirm(String isConfirm) {
  ...
  */
  ...
  public WaterCustomer confirmDate(OffsetDateTime confirmDate) {
  ...
  */
  ...
  public WaterCustomer reason(String reason) {
  ...
  */
  ...
  public WaterCustomer packageId(Integer packageId) {
  ...
  */
  ...
  public JsonNullable<Integer> getPackageId() {
    return packageId;
  }

  public void setPackageId(JsonNullable<Integer> packageId) {
    this.packageId = packageId;
  }

  public WaterCustomer discount(Double discount) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    WaterCustomer waterCustomer = (WaterCustomer) o;
    return Objects.equals(this.visitId, waterCustomer.visitId) &&
        Objects.equals(this.customerId, waterCustomer.customerId) &&
        Objects.equals(this.name, waterCustomer.name) &&
        Objects.equals(this.mobile, waterCustomer.mobile) &&
        equalsNullable(this.emailId, waterCustomer.emailId) &&
        equalsNullable(this.city, waterCustomer.city) &&
        equalsNullable(this.ticketNo, waterCustomer.ticketNo) &&
        equalsNullable(this.ticketDate, waterCustomer.ticketDate) &&
        Objects.equals(this.isDelete, waterCustomer.isDelete) &&
        Objects.equals(this.remainingPaidAmt, waterCustomer.remainingPaidAmt) &&
        Objects.equals(this.createDate, waterCustomer.createDate) &&
        equalsNullable(this.reference, waterCustomer.reference) &&
        equalsNullable(this.paymentBy, waterCustomer.paymentBy) &&
        equalsNullable(this.paymentDetails, waterCustomer.paymentDetails) &&
        Objects.equals(this.isAdvance, waterCustomer.isAdvance) &&
        equalsNullable(this.userId, waterCustomer.userId) &&
        equalsNullable(this.noOfMembers, waterCustomer.noOfMembers) &&
        Objects.equals(this.totalAmount, waterCustomer.totalAmount) &&
        equalsNullable(this.serviceId, waterCustomer.serviceId) &&
        Objects.equals(this.advance, waterCustomer.advance) &&
        Objects.equals(this.remaining, waterCustomer.remaining) &&
        equalsNullable(this.adults, waterCustomer.adults) &&
        equalsNullable(this.childrens, waterCustomer.childrens) &&
        equalsNullable(this.rate, waterCustomer.rate) &&
        equalsNullable(this.adultRate, waterCustomer.adultRate) &&
        equalsNullable(this.childRate, waterCustomer.childRate) &&
        equalsNullable(this.bookingUId, waterCustomer.bookingUId) &&
        equalsNullable(this.bookingToDate, waterCustomer.bookingToDate) &&
        Objects.equals(this.isDone, waterCustomer.isDone) &&
        equalsNullable(this.isConfirm, waterCustomer.isConfirm) &&
        equalsNullable(this.confirmDate, waterCustomer.confirmDate) &&
        equalsNullable(this.reason, waterCustomer.reason) &&
        equalsNullable(this.packageId, waterCustomer.packageId) &&
        Objects.equals(this.discount, waterCustomer.discount);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(visitId, customerId, name, mobile, hashCodeNullable(emailId), hashCodeNullable(city), hashCodeNullable(ticketNo), hashCodeNullable(ticketDate), isDelete, remainingPaidAmt, createDate, hashCodeNullable(reference), hashCodeNullable(paymentBy), hashCodeNullable(paymentDetails), isAdvance, hashCodeNullable(userId), hashCodeNullable(noOfMembers), totalAmount, hashCodeNullable(serviceId), advance, remaining, hashCodeNullable(adults), hashCodeNullable(childrens), hashCodeNullable(rate), hashCodeNullable(adultRate), hashCodeNullable(childRate), hashCodeNullable(bookingUId), hashCodeNullable(bookingToDate), isDone, hashCodeNullable(isConfirm), hashCodeNullable(confirmDate), hashCodeNullable(reason), hashCodeNullable(packageId), discount);
  }
