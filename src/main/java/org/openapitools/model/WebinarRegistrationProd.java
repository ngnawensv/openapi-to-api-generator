...
public class WebinarRegistrationProd {
  ...
  public WebinarRegistrationProd() {
    super();
  }
   ...
   */
  public WebinarRegistrationProd(String name, String mobileNo) {
    this.name = name;
    this.mobileNo = mobileNo;
  }

  public WebinarRegistrationProd registrationId(Integer registrationId) {
  ...
  */
  ...
  public WebinarRegistrationProd name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public WebinarRegistrationProd mobileNo(String mobileNo) {
    this.mobileNo = mobileNo;
    return this;
  }
  ...
  */
  ...
  public WebinarRegistrationProd emailId(String emailId) {
  ...
  */
  ...
  public WebinarRegistrationProd linkdinProfileUrl(String linkdinProfileUrl) {
  ...
  */
  ...
  public WebinarRegistrationProd isWorking(Boolean isWorking) {
  ...
  */
  ...
  public WebinarRegistrationProd collegeName(String collegeName) {
  ...
  */
  ...
  public WebinarRegistrationProd city(String city) {
  ...
  */
  ...
  public WebinarRegistrationProd gender(String gender) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    WebinarRegistrationProd webinarRegistrationProd = (WebinarRegistrationProd) o;
    return Objects.equals(this.registrationId, webinarRegistrationProd.registrationId) &&
        Objects.equals(this.name, webinarRegistrationProd.name) &&
        Objects.equals(this.mobileNo, webinarRegistrationProd.mobileNo) &&
        equalsNullable(this.emailId, webinarRegistrationProd.emailId) &&
        equalsNullable(this.linkdinProfileUrl, webinarRegistrationProd.linkdinProfileUrl) &&
        Objects.equals(this.isWorking, webinarRegistrationProd.isWorking) &&
        equalsNullable(this.collegeName, webinarRegistrationProd.collegeName) &&
        equalsNullable(this.city, webinarRegistrationProd.city) &&
        equalsNullable(this.gender, webinarRegistrationProd.gender);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebinarRegistrationProd {\n");
